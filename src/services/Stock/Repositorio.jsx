...
export default class repositorioStock{
    ...
    constructor(){
        this.endpoint =" https://api3.mozsystems.com/tenant2/stock"
    ...
    async cadastrar(stock) {
      ...
      async buscarMercadoria(){
        try {
            const res = await fetch("http://localhost:5000/tenant2/mercadoria", {  // Adicione 'await' e utilize o this.endpoint
              method: 'GET',
